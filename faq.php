...
<html lang="en">
    <head>
        <title>Yogsearch Frequently asked questions</title>
        <meta charset="utf-8">
    ...
    <body class="faq-width">
        ...
        <a href='/'> << Go back</a> </div><br><br>
            ...
            <section id="faq">
                ...
                <p>While not technically a question, I am sure you could and I hope you will!<br> The source code is free and available on my Github.<br> If you do make a better page, please let me know. I'd love to use it! </p>
                </article>
            </section>
            <br>
            <section id="contact">
